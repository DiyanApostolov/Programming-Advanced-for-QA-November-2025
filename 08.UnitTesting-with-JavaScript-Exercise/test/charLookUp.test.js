...
describe('test_charLokUp', () => {
    ...
    it('shoud return undefined if second parameter is not am integer umber', () =>{
    ...
    it('shoud return "Incorrect index" if index is out of range', ()=>{
        // Arrange
    ...
    it('shoud return characrer if all parameteres are valid', () => {
